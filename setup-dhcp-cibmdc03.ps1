...
Add-DhcpServerv4Scope -Name "Datacenter" -StartRange 10.111.13.65 -EndRange 10.111.13.128 -SubnetMask 255.255.248.0
Add-DhcpServerv4Scope -Name "Champaign" -StartRange 10.12.13.65 -EndRange 10.12.13.128 -SubnetMask 255.255.248.0
Add-DhcpServerv4Scope -Name "Urbana" -StartRange 10.13.13.65 -EndRange 10.13.13.128 -SubnetMask 255.255.248.0 
Add-DhcpServerv4Scope -Name "Midtown" -StartRange 10.14.13.65 -EndRange 10.14.13.128 -SubnetMask 255.255.248.0
Add-DhcpServerv4Scope -Name "Monticello" -StartRange 10.16.13.65 -EndRange 10.16.13.128 -SubnetMask 255.255.248.0 
Add-DhcpServerv4Scope -Name "Danville" -StartRange 10.17.13.65 -EndRange 10.17.13.128 -SubnetMask 255.255.248.0
Add-DhcpServerv4Scope -Name "Avenue" -StartRange 10.25.13.65 -EndRange 10.25.13.128 -SubnetMask 255.255.248.0
Add-DhcpServerv4Scope -Name "Wheaton" -StartRange 10.31.13.65 -EndRange 10.31.13.128 -SubnetMask 255.255.248.0
Add-DhcpServerv4Scope -Name "Waukesha" -StartRange 10.41.13.65 -EndRange 10.41.13.128 -SubnetMask 255.255.248.0
Add-DhcpServerv4Scope -Name "Elm Grove" -StartRange 10.44.13.65 -EndRange 10.44.13.128 -SubnetMask 255.255.248.0
Add-DhcpServerv4Scope -Name "Clear Water" -StartRange 10.51.13.65 -EndRange 10.51.13.128 -SubnetMask 255.255.248.0
Add-DhcpServerv4Scope -Name "Bloomington" -StartRange 10.211.13.65 -EndRange 10.211.13.128 -SubnetMask 255.255.248.0
Add-DhcpServerv4Scope -Name "Sheridan" -StartRange 10.221.13.65 -EndRange 10.221.13.128 -SubnetMask 255.255.248.0         
